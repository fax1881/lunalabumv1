...
const BOYUTLAR = [
  ...
  { label: "100x150 cm", value: "100x150" },
];
...
const EditorPage = () => {
  ...
  const handleTasarimKaydet = () => {
    ...
    images.forEach((img, idx) => {
      tasarimlar.push({ image: img, name: `Bez Baskı Tasarımı ${tasarimlar.length + 1}` });
    });
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center py-8">
        <h1 className="text-3xl font-semibold mb-6 text-primary-700">Bez Baskı Editörü</h1>
        <div className="mb-6">
          <input
            type="file"
            accept="image/*"
